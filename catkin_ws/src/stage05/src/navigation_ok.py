...
def callback_position(data):
    ...
    file = open("/home/shikur/CIRE-2022/catkin_ws/src/stage05/src/csv_files/stage05.csv")
...
def main():    
    global obstacle_detected, distance, error, target_angle, hsrb_angle, row, goal_x_pos, goal_y_/stage05/waypointpos, hsrb_x_pos, hsrb_y_pos, goal_theta_pos, row, rows, bandera
    rospy.init_node('navigation_ok', anonymous=True)
    rospy.Subscriber("/global_pose", PoseStamped, callback_position)
    rospy.Subscriber("/stage05/waypoint", Bool, callback_waypoint)
